...
from ..models.wan_video_dit import WanModel, sinusoidal_embedding_1d, init_local_downsample_mask_flex, BLOCK_MASK as flex_block_mask
...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        spatial_down_factor: Optional[int] = 2,
    ):
        # Scheduler
        ...
        inputs_shared = {
            ...
            "vap_video": vap_video, 
            "base": base,
            "spatial_down_factor": spatial_down_factor
        }
...
def model_fn_wan_video(
    ...
    **kwargs,
    ...
    # blocks
    # Auto-initialize flex attention mask for spatial downsample if needed
    if not base and flex_block_mask is None:
        ...
        for block_id, block in enumerate(dit.blocks):
            ...
            if vap is not None and block_id in vap.mot_layers_mapping:
                ...
                if use_gradient_checkpointing_offload:
                    ...
                    x = block(x, context, t_mod, freqs, num_frames = (num_frames - 1) // 4 + 1, height = height // 32, width = width // 32, base=base, spatial_down_factor = spatial_down_factor)
